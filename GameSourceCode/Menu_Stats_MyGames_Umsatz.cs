...
public class Menu_Stats_MyGames_Umsatz : MonoBehaviour
{
	...
	public void InitDropdowns()
	{
		...
		list.Add(tS_.GetText(1370));
		list.Add(tS_.GetText(1371));
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_MyGames_Umsatz component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_MyGames_Umsatz>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
