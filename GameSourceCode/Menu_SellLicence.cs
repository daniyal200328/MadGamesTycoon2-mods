	...
	private void SetData()
	{
		for (int i = 0; i < licences_.licence_GEKAUFT.Length; i++)
		{
			if (licences_.licence_GEKAUFT[i] > 0)
			{
				...
				{
					Item_SellLicence component = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_SellLicence>();
					component.myID = i;
