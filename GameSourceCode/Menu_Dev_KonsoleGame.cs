...
public class Menu_Dev_KonsoleGame : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && CheckGameData(component) && (value - 1 == component.maingenre || value == 0))
			{
				...
				{
					Item_KonsoleGame component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_KonsoleGame>();
					...
					component2.menu_ = menuDevKonsole_;
				}
			}
		}
		DROPDOWN_Sort();
	...
	{
		if ((bool)script_ && script_.ownerID == mS_.myID && !script_.freeware && !script_.typ_bundle && !script_.typ_bundleAddon && !script_.typ_addon && !script_.typ_addonStandalone && !script_.typ_contractGame && !script_.typ_mmoaddon && !script_.typ_goty && !script_.inDevelopment && !script_.schublade && script_.gameTyp == 0 && !script_.arcade && !script_.handy)
		{
			return true;
		}
		return false;
