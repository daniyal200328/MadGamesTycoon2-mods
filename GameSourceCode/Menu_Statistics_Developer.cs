...
public class Menu_Statistics_Developer : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if (component.isUnlocked && component.developer && component.myID != mS_.myID && (!uiObjects[1].GetComponent<Toggle>().isOn || !component.IsTochterfirma()) && (!uiObjects[7].GetComponent<Toggle>().isOn || (uiObjects[7].GetComponent<Toggle>().isOn && component.KaufangebotFree())))
			{
				...
				{
					Item_Stats_Developer component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_Stats_Developer>();
