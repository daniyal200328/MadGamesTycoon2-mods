...
public class Menu_InAppVerwalten : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && CheckGameData(component))
			{
				...
				{
					Item_InAppVerwalten component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_InAppVerwalten>();
	...
	{
		if ((bool)script_ && (script_.ownerID == mS_.myID || script_.publisherID == mS_.myID) && !script_.typ_bundle && !script_.typ_addon && !script_.typ_addonStandalone && !script_.typ_contractGame && !script_.typ_mmoaddon && !script_.inDevelopment && script_.isOnMarket && ((script_.gameGameplayFeatures[57] && script_.gameGameplayFeatures[23]) || script_.gameTyp == 2))
		{
			return true;
		}
		return false;
