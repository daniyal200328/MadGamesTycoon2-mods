...
public class Item_DevGame_MMOAddon : MonoBehaviour
{
	...
	private void SetData()
	{
		if ((bool)game_)
		{
			...
			uiObjects[5].GetComponent<Text>().text = tS_.GetText(1236) + ": " + mS_.GetMoney(game_.abonnements, showDollar: false);
			...
			uiObjects[6].GetComponent<Text>().text = game_.amountMMOAddons.ToString();
	...
	public void BUTTON_Click()
	{
		...
		guiMain_.ActivateMenu(guiMain_.uiObjects[247]);
		guiMain_.uiObjects[247].GetComponent<Menu_Dev_MMOAddon>().Init(rS_, game_);
	}
}
