...
public class Menu_ShowKonsoleDetailsSelect : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_KonsoleDetailsSelect component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_KonsoleDetailsSelect>();
	...
	{
		if ((bool)script_ && script_.ownerID == mS_.myID)
		{
			return true;
		}
		return false;
