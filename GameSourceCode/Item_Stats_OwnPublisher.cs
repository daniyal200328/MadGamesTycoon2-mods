...
public class Item_Stats_OwnPublisher : MonoBehaviour
{
	...
	{
		guiMain_.uiObjects[393].GetComponent<Menu_Stats_TochterfirmaSettings>().pS_.tf_ownPublisherPriority = pS_.myID;
		guiMain_.uiObjects[393].GetComponent<Menu_Stats_TochterfirmaSettings>().UpdateData();
		guiMain_.uiObjects[431].GetComponent<Menu_Stats_TochterfirmaOwnPublisher>().BUTTON_Close();
	}
}
