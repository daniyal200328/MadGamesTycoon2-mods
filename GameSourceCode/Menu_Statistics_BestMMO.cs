...
public class Menu_Statistics_BestMMO : MonoBehaviour
{
	...
	public void InitDropdowns()
	{
		...
		list.Add(tS_.GetText(1906));
		list.Add(tS_.GetText(1903));
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && component.gameTyp == 1 && ((value == 0 && !component.inDevelopment && component.isOnMarket && component.abonnements > 0) || (value == 1 && !component.inDevelopment && component.bestAbonnements > 0)))
			{
