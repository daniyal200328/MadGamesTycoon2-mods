...
public class Menu_DevGame_Engine : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && !component.archiv_engine && ((component.isUnlocked && component.gekauft) || (component.ownerID == mS_.myID && component.devPointsStart <= 0f) || (component.ownerID == mS_.myID && component.updating)))
			{
				...
				{
					Item_DevGame_Engine component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_DevGame_Engine>();
					...
					component2.mDevGame_ = mDevGame_;
				}
			}
		}
		DROPDOWN_Sort();
