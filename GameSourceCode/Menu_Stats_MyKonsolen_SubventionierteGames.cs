...
public class Menu_Stats_MyKonsolen_SubventionierteGames : MonoBehaviour
{
	...
	private bool Exists(GameObject parent_, int id_)
	{
		...
		{
			if (parent_.transform.GetChild(i).GetComponent<Item_MyKonsolen_SubventionGames>().pS_.myID == id_)
			{
				return true;
			}
		}
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				if ((bool)component && CheckKonsoleData(component) && !Exists(uiObjects[0], component.myID))
				{
					...
					Item_MyKonsolen_SubventionGames component2 = obj.GetComponent<Item_MyKonsolen_SubventionGames>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
					component2.sfx_ = sfx_;
					component2.guiMain_ = guiMain_;
					component2.pS_ = component;
					obj.name = component.games.ToString();
				}
			}
		}
