...
public class Menu_Dev_MMOAddon : MonoBehaviour
{
	...
	public void BUTTON_Start()
	{
		...
		if (num < 3)
		{
			guiMain_.MessageBox(tS_.GetText(1258), closeMenu: false);
			OpenSide(0);
			return;
		}
		...
		int num2 = Mathf.RoundToInt(GetDevCosts());
		mS_.Pay(num2, 18);
		...
		for (int num3 = 0; num3 < gS_.gamePlatform.Length; num3++)
		{
			gameScript2.gamePlatform[num3] = gS_.gamePlatform[num3];
		}
		for (int num4 = 0; num4 < gS_.gameEngineFeature.Length; num4++)
		{
			gameScript2.gameEngineFeature[num4] = gS_.gameEngineFeature[num4];
			gameScript2.engineFeature_DevDone[num4] = gS_.engineFeature_DevDone[num4];
		}
		for (int num5 = 0; num5 < gS_.gameplayStudio.Length; num5++)
		{
			gameScript2.gameplayStudio[num5] = gS_.gameplayStudio[num5];
		}
		for (int num6 = 0; num6 < gS_.grafikStudio.Length; num6++)
		{
			gameScript2.grafikStudio[num6] = gS_.grafikStudio[num6];
		}
		for (int num7 = 0; num7 < gS_.soundStudio.Length; num7++)
		{
			gameScript2.soundStudio[num7] = gS_.soundStudio[num7];
		}
		for (int num8 = 0; num8 < gS_.motionCaptureStudio.Length; num8++)
		{
			gameScript2.motionCaptureStudio[num8] = gS_.motionCaptureStudio[num8];
		}
		...
		guiMain_.uiObjects[246].SetActive(value: false);
		base.gameObject.SetActive(value: false);
	}
