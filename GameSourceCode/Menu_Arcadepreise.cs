...
public class Menu_Arcadepreise : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && CheckGameData(component))
			{
				...
				{
					Item_Arcadepreis component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_Arcadepreis>();
	...
	{
		if ((bool)script_ && script_.ownerID == mS_.myID && script_.developerID == mS_.myID && !script_.inDevelopment && script_.isOnMarket && script_.publisherID == mS_.myID && script_.gameTyp != 2 && script_.arcade)
		{
			return true;
		}
		return false;
