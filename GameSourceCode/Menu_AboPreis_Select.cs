...
public class Menu_AboPreis_Select : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && CheckGameData(component))
			{
				...
				{
					Item_AboPreis component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_AboPreis>();
	...
	{
		if ((bool)script_ && (script_.ownerID == mS_.myID || script_.publisherID == mS_.myID) && !script_.inDevelopment && script_.isOnMarket && script_.gameTyp == 1)
		{
			return true;
		}
		return false;
