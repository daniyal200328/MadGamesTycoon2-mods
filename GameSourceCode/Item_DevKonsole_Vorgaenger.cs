...
public class Item_DevKonsole_Vorgaenger : MonoBehaviour
{
	...
	public void BUTTON_Click()
	{
		...
		guiMain_.uiObjects[318].GetComponent<Menu_Dev_Konsole>().SetVorgaenger(pS_.myID);
		guiMain_.uiObjects[448].GetComponent<Menu_Dev_KonsoleVorgaenger>().BUTTON_Close();
	}
}
