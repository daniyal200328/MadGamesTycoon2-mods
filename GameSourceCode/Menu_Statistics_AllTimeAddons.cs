	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				if ((bool)component && (component.typ_addon || component.typ_mmoaddon || component.typ_addonStandalone) && !component.inDevelopment && !component.pubAngebot && component.sellsTotal > 0 && !Exists(uiObjects[0], component.myID))
				{
