...
$refs += @(
    ...
    (Join-Path $pluginsDir "SubsidiaryProjectDirector.dll"),
    (Join-Path $pluginsDir "DynamicSubsidiaryTimeline.dll"),
    (Join-Path $pluginsDir "DynamicStudioGoodwill.dll"),
    (Join-Path $pluginsDir "Subsidiary2.dll")
)
