...
public class Menu_ReleaseDate : MonoBehaviour
{
	...
	public void BUTTON_Ok()
	{
		...
		if (!gS_.typ_budget && !gS_.typ_bundle && !gS_.typ_bundleAddon && !gS_.typ_goty)
		{
		...
		guiMain_.uiObjects[218].SetActive(value: false);
		guiMain_.uiObjects[267].SetActive(value: false);
		guiMain_.uiObjects[271].SetActive(value: false);
		guiMain_.uiObjects[274].SetActive(value: false);
		guiMain_.uiObjects[275].SetActive(value: false);
		guiMain_.uiObjects[227].SetActive(value: false);
		guiMain_.uiObjects[228].SetActive(value: false);
