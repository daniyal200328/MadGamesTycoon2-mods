	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				if ((bool)component && component.ownerID == mS_.myID && !component.vomMarktGenommen && !Exists(uiObjects[0], component.myID))
				{
					Item_Marketing_Konsole component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_Marketing_Konsole>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
