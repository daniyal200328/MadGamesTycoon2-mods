...
public class Item_KonsoleGame : MonoBehaviour
{
	...
	public void BUTTON_Click()
	{
		...
		menu_.SetGame(game_.myID);
		guiMain_.uiObjects[320].SetActive(value: false);
