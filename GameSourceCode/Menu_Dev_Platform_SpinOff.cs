...
public class Menu_Dev_Platform_SpinOff : MonoBehaviour
{
	...
	public void BUTTON_PCundKonsole()
	{
		...
		guiMain_.uiObjects[56].GetComponent<Menu_DevGame>().InitSpinoff(rS_, gS_.myID, 0);
		base.gameObject.SetActive(value: false);
	}
	...
	public void BUTTON_Handy()
	{
		sfx_.PlaySound(3, force: true);
		guiMain_.ActivateMenu(guiMain_.uiObjects[56]);
		guiMain_.uiObjects[56].GetComponent<Menu_DevGame>().InitSpinoff(rS_, gS_.myID, 5);
		base.gameObject.SetActive(value: false);
	}
	...
	public void BUTTON_Arcade()
	{
		sfx_.PlaySound(3, force: true);
		guiMain_.ActivateMenu(guiMain_.uiObjects[56]);
		guiMain_.uiObjects[56].GetComponent<Menu_DevGame>().InitSpinoff(rS_, gS_.myID, 4);
		base.gameObject.SetActive(value: false);
	}
