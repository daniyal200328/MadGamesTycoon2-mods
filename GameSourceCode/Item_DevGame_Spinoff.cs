...
public class Item_DevGame_Spinoff : MonoBehaviour
{
	...
	private void SetData()
	{
		if ((bool)game_)
		{
			...
			uiObjects[6].GetComponent<Text>().text = game_.GetHypeSpinoff().ToString();
	...
	public void BUTTON_Click()
	{
		...
		guiMain_.ActivateMenu(guiMain_.uiObjects[370]);
		guiMain_.uiObjects[370].GetComponent<Menu_Dev_Platform_SpinOff>().Init(rS_, game_);
		guiMain_.uiObjects[310].SetActive(value: false);
	}
}
