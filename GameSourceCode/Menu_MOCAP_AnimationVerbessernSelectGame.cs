	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				if ((bool)component && CheckGameData(component) && !menuMocap_.WirdInAnderenRaumBearbeitet(0, component) && !menuMocap_.WirdInAnderenRaumBearbeitet(1, component) && !menuMocap_.WirdInAnderenRaumBearbeitet(2, component) && !menuMocap_.WirdInAnderenRaumBearbeitet(3, component) && !menuMocap_.WirdInAnderenRaumBearbeitet(4, component) && !menuMocap_.WirdInAnderenRaumBearbeitet(5, component) && !Exists(uiObjects[0], component.myID))
				{
					Item_MOCAP_AnimationVerbessern component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_MOCAP_AnimationVerbessern>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
