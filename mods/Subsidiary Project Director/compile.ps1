...
$src = Join-Path $PSScriptRoot "SubsidiaryProjectDirectorPlugin.cs"
$out = Join-Path $root "BepInEx\plugins\SubsidiaryProjectDirector.dll"
...
foreach ($optionalPlugin in @("Subsidiary2", "DynamicSubsidiaryTimeline")) {
