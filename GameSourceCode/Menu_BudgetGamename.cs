...
public class Menu_BudgetGamename : MonoBehaviour
{
	...
	public void BUTTON_Name(int i)
	{
		...
		if ((bool)game_)
		{
			uiObjects[0].GetComponent<Text>().text = game_.GetNameSimple() + " <color=grey><i>" + tS_.GetText(1154 + i) + "</i></color>";
	...
	public void BUTTON_Yes()
	{
		...
		if (array.Length != 0)
		{
			for (int i = 0; i < array.Length; i++)
			{
				...
				if ((bool)component && component.GetNameSimple() == uiObjects[0].GetComponent<Text>().text)
				{
