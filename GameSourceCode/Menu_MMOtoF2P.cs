...
public class Menu_MMOtoF2P : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_MMOtoF2P component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_MMOtoF2P>();
	...
	{
		if ((bool)script_ && script_.ownerID == mS_.myID && !script_.typ_bundle && !script_.typ_bundleAddon && !script_.typ_addon && !script_.typ_addonStandalone && !script_.typ_contractGame && !script_.inDevelopment && script_.gameTyp == 1 && !script_.mmoTOf2p_created && (script_.publisherID == mS_.myID || (!script_.isOnMarket && script_.publisherID != mS_.myID)) && !script_.pubOffer)
		{
			return true;
		}
		return false;
