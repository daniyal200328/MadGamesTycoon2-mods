...
public class Menu_Statistics_Engines : MonoBehaviour
{
	...
	{
		InitDropdowns();
		Init(uiObjects[5].GetComponent<Toggle>().isOn);
	}
	...
	private void MultiplayerUpdate()
	{
		if (mS_.multiplayer)
		{
			...
			{
				updateTimer = 0f;
				SetData(uiObjects[5].GetComponent<Toggle>().isOn);
			}
		}
	}
	...
	private void SetData(bool nurEigeneEngines)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && component.myID != 0 && ((component.ownerID == mS_.myID && (component.Complete() || component.updating)) || (component.ownerID != mS_.myID && component.isUnlocked)) && (!nurEigeneEngines || (component.ownerID == mS_.myID && nurEigeneEngines)))
			{
				...
				{
					Item_Stats_Engine component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_Stats_Engine>();
