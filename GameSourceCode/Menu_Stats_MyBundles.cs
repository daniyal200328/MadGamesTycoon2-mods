...
public class Menu_Stats_MyBundles : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_MyBundles component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_MyBundles>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
	...
	{
		if ((bool)script_ && script_.developerID == mS_.myID && !script_.inDevelopment && (script_.typ_bundle || script_.typ_bundleAddon))
		{
			return true;
		}
		return false;
