...
public class Menu_ProductionArcadeSelect : MonoBehaviour
{
	...
	public void InitDropdowns()
	{
		...
		list.Add(tS_.GetText(1511));
		list.Add(tS_.GetText(1125));
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_WerkstattSelect component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_WerkstattSelect>();
