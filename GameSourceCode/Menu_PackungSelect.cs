...
public class Menu_PackungSelect : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && CheckGameData(component))
			{
				...
				{
					Item_PackungSelect component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_PackungSelect>();
	...
	{
		if ((bool)script_ && script_.publisherID == mS_.myID && !script_.inDevelopment && script_.isOnMarket && script_.gameTyp != 2 && !script_.handy && !script_.arcade)
		{
			return true;
		}
		return false;
