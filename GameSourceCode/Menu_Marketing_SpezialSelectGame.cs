...
public class Menu_Marketing_SpezialSelectGame : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_MarketingSpezial_Game component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_MarketingSpezial_Game>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
	...
	{
		if ((bool)script_ && (script_.developerID == mS_.myID || script_.publisherID == mS_.myID) && (script_.inDevelopment || script_.isOnMarket || script_.schublade) && !script_.typ_contractGame)
		{
			return true;
		}
		return false;
