...
public class Menu_QA_ShowSpielberichtSelectGame : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			if ((bool)component && CheckGameData(component) && (value - 1 == component.maingenre || value == 0))
			{
				...
				{
					Item_QA_ShowSpielbericht component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_QA_ShowSpielbericht>();
	...
	{
		if ((bool)script_ && script_.developerID == mS_.myID && !script_.archiv_spielbericht && script_.spielbericht && !script_.typ_budget && !script_.typ_goty)
		{
			return true;
		}
		return false;
