	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				if ((bool)component && component.gameTyp == 2 && !component.inDevelopment && component.isOnMarket && component.sellsTotal > 0 && !Exists(uiObjects[0], component.myID))
				{
					GameObject obj = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform);
					Item_BestF2P component2 = obj.GetComponent<Item_BestF2P>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
