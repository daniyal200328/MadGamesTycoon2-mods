...
public class Menu_Stats_Developer_IPs : MonoBehaviour
{
	...
	private void SetData()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			if ((bool)array[i])
			{
				...
				{
					Item_MyGames_MyIPs component2 = Object.Instantiate(uiPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity, uiObjects[0].transform).GetComponent<Item_MyGames_MyIPs>();
					component2.mS_ = mS_;
					component2.tS_ = tS_;
	...
	{
		if ((bool)script_ && !script_.inDevelopment && !script_.pubAngebot && !script_.auftragsspiel && script_.IsMyIP(pS_) && script_.mainIP == script_.myID)
		{
			return true;
		}
		return false;
