...
public class Item_MyBundles : MonoBehaviour
{
	...
	public void BUTTON_Click()
	{
		...
		if (game_.typ_bundle)
		{
			guiMain_.uiObjects[269].SetActive(value: true);
			guiMain_.uiObjects[269].GetComponent<Menu_BundleView>().Init(game_);
		}
		else if (game_.typ_bundleAddon)
		{
			guiMain_.uiObjects[273].SetActive(value: true);
			guiMain_.uiObjects[273].GetComponent<Menu_BundleView>().Init(game_);
		}
	}
}
