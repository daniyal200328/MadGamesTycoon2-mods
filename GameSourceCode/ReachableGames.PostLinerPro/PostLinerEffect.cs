...
public sealed class PostLinerEffect : PostProcessEffectRenderer<PostLinerPro>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		if (globalTexture != null)
		{
			...
			propertySheet.properties.SetColor(_fillColorHiddenId, base.settings.fillColorHidden);
			propertySheet.properties.SetFloat(_fillBlendId, base.settings.fillBlend);
			propertySheet.properties.SetFloat(_fillBlendHiddenId, base.settings.fillBlendHidden);
			...
			propertySheet.properties.SetColor(_outlineColorHiddenId, base.settings.outlineColorHidden);
			...
			propertySheet.properties.SetFloat(_topologyBlendHiddenId, base.settings.topologyBlendHidden);
			...
			propertySheet.properties.SetFloat(_fadeDistanceId, base.settings.fadeDistance);
